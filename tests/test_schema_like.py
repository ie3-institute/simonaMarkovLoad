...
def test_schema_structure_completeness(small_df, tiny_models):
    ...
    expected_top_keys = {
        "schema", "generated_at", "generator", "time_model", 
    ...
    expected_time_keys = {
        "bucket_count", "bucket_encoding", "sampling_interval_minutes", "timezone"
    }
...
@pytest.mark.skipif(True, reason="JSON schema validation skipped - add jsonschema dependency to enable")
def test_jsonschema_validation(small_df, tiny_models):
    ...
    schema = {
        "type": "object",
        "required": ["schema", "generated_at", "generator", "time_model", 
                    "value_model", "parameters", "data"],
        "properties": {
            ...
            "time_model": {
                ...
                "properties": {
                    "bucket_count": {"type": "integer", "enum": [2304]}
                }
            },
            "data": {
                "type": "object",
